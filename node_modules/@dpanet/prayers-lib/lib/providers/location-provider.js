...
exports.LocationProviderFactory = exports.LocationProviderName = void 0;
...
class GoogleLocationProvider extends LocationProvider {
    ...
    async getLocationByCoordinates(lat, lng) {
        ...
        if (!(0, isNullOrUndefined_1.isNullOrUndefined)(lat) && !(0, isNullOrUndefined_1.isNullOrUndefined)(lng)) {
            ...
            if ((0, isNullOrUndefined_1.isNullOrUndefined)(googleLocation))
    ...
    async getLocationByAddress(address, countryCode) {
        let locationinput = {
            address: address,
            components: { country: (0, isNullOrUndefined_1.isNullOrUndefined)(countryCode) ? "" : countryCode }
        };
        let googleLocation, err;
        if (!(0, isNullOrUndefined_1.isNullOrUndefined)(address)) {
    ...
    parseLocation(googleLocation) {
        ...
        if (!(0, isNullOrUndefined_1.isNullOrUndefined)(googleLocation) && googleLocation.json.results.length > 0) {
            ...
            if ((0, isNullOrUndefined_1.isNullOrUndefined)(locationCoordinates) || (0, isNullOrUndefined_1.isNullOrUndefined)(locationAddress) || (0, isNullOrUndefined_1.isNullOrUndefined)(locationCountry) || (0, isNullOrUndefined_1.isNullOrUndefined)(locationCity))
