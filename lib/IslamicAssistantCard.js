...
class IslamicAssistantCard {
  ...
  _systemPrompt(cfg) {
    ...
    return [
      ...
      '      sharh is delivered as the placeholder. This is the preferred outcome. Below the placeholder add',
      '      ONE formatted Markdown link straight to that hadith page (you have its id from the selector):',
      '      [📖 المصدر على HadeethEnc](https://hadeethenc.com/ar/browse/hadith/<id>)  — use /en/ for English users.',
